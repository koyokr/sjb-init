...
Write-Host '[!] install-vscode'; download-string 'https://sjb.koyo.io/src/install-vscode.ps1' | iex | Out-Null
Write-Host '[!] install-clojure'; download-string 'https://sjb.koyo.io/src/install-clojure.ps1' | iex | Out-Null
Write-Host '[!] install-putty'; download-string 'https://sjb.koyo.io/src/install-putty.ps1' | iex | Out-Null
