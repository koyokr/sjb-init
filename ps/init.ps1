...
write-host '[!] disable-policies'; disable-policies
write-host '[!] configure-dns'; configure-dns
write-host '[!] configure-hosts'; configure-hosts
write-host '[!] install-choco'; install-choco
write-host '[!] install-chrome'; install-chrome
write-host '[!] install-vscode'; install-vscode
write-host '[!] install-powershell'; install-powershell
